...
if __name__ == "__main__":
    ...
    validate_no_spaces_begin_or_end(
        arg_name="{{ cookiecutter.library_description }}", human_readable_name="library_description"
    )  # pragma: no cover

    validate_semantic_version(
        arg_name="{{ cookiecutter.library_version }}", human_readable_name="library_version"
    )  # pragma: no cover
